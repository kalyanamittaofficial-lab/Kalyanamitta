  ...
  return (
    <div className="mobile-padding" style={{ padding: '0 48px', marginTop: '100px', width: '100%', maxWidth: '1400px', margin: '100px auto 0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '40px' }}>
        <h3 style={{ fontSize: '2rem', color: 'var(--primary)', fontWeight: '700', fontFamily: 'var(--font-serif)' }}>නවතම දේශනා</h3>
      ...
      <div 
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', maxWidth: '400px', lineHeight: '1.6', fontFamily: 'var(--font-sinhala)' }}>නවතම ධර්ම දේශනා ඉතා ඉක්මනින් මෙහි යාවත්කාලීන කරනු ලැබේ.</p>
      </div>
    </div>
  );
}
